...
console.log(
  "The base32 value should be entered in the Google Authenticator App"
);
console.log("");
console.log(
  "Open the following URL for a QR code.  Google Authenticator can read this QR code using your phone's camera:"
);
console.log(
